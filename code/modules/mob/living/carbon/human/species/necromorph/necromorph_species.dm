...
/datum/species/necromorph
	...
	*/
	...
	species_flags = SPECIES_FLAG_NO_PAIN|SPECIES_FLAG_NO_MINOR_CUT|SPECIES_FLAG_NO_POISON|SPECIES_FLAG_NO_BLOCK|SPECIES_FLAG_NO_SCAN      // Various specific features.
...
/datum/species/necromorph/onDestroy(mob/living/carbon/human/H)
...
/datum/species/necromorph/proc/get_weighted_total_limb_damage(mob/living/carbon/human/H, return_list)
	var/total = 0
	var/blocked = 0
	if (!initial_health_values)
...
/datum/species/necromorph/handle_post_spawn(mob/living/carbon/human/H)
	.=..()
